...
USERNAME = environ.get('USERNAME', "https://t.me/Alphaz_Officials") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002266913790'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/M0VIES_REQUEST_Group')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002328414420').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
...
request_channel = environ.get('REQUEST_CHANNEL', '-1002289995477') # If anyone sends a request message to your bot, you will get it in this channel.
...
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/Links_Tutorialz/14")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/Links_Tutorialz/14")
VERIFY_IMG = environ.get("VERIFY_IMG", "https://graph.org/file/1669ab9af68eaa62c3ca4.jpg")
SHORTENER_API = environ.get("SHORTENER_API", "7565b54ead36267a2a570fe3ab7f4fd39ebe5450")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", 'shortxlinks.com')
SHORTENER_API2 = environ.get("SHORTENER_API2", "7565b54ead36267a2a570fe3ab7f4fd39ebe5450")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'shortxlinks.com')
SHORTENER_API3 = environ.get("SHORTENER_API3", "7565b54ead36267a2a570fe3ab7f4fd39ebe5450")
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://graph.org/file/04729c9cc364a7278372b-1d7d9857f26854166c.jpg')).split()
